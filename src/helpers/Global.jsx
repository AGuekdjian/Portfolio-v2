...
export const Global = {
  ...
  projects: [
    {
      id: 1,
      title: "Sitio web de AmCham Argentina",
      description: "AmCham Argentina",
      img: AmCham,
      liveLink: "https://www.onboarding.amcham.com.ar/",
      technologies: [Tags.REACT, Tags.TAILWIND],
      github: "https://github.com/AGuekdjian",
    },
    {
      id: 2,
      title: "Sitio web de AmCham Connect",
      description: "AmCham Connect",
      img: Eventos,
      liveLink: "https://www.eventos.amcham.com.ar/",
      technologies: [Tags.REACT, Tags.TAILWIND],
      github: "https://github.com/AGuekdjian",
    },
    {
      id: 3,
      title: "Sitio web de AmCham Diversidad",
      description: "AmCham Diversidad",
      img: Diversidad,
      liveLink: "https://www.diversidad.amcham.com.ar/",
      technologies: [Tags.REACT, Tags.TAILWIND],
      github: "https://github.com/AGuekdjian",
    },
    {
      id: 4,
      title: "Sitio web de AmCham Sponsors",
      description: "AmCham Sponsors",
      img: Sponsors,
      liveLink: "https://www.sponsorship.amcham.com.ar/",
      technologies: [Tags.REACT, Tags.TAILWIND],
      github: "https://github.com/AGuekdjian",
    },
  ],
